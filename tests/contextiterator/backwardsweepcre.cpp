...
*******************************************************************************
    ...
    $Id: backwardsweepcre.cpp,v 1.1 2006/12/07 06:58:59 ben Exp $
...
void maybeThrowSpanner( int i, int spannerfile_count, const char*const spannerfile )
{
...
int main( int argc, char** argv )
{
    ...
    Context::reverse_iterator ci = c->rbegin();
    for( int i=0;
         ci != c->rend();
         ++ci, ++i )
    {
        cerr << "ci:" << (*ci)->getDirName() << endl;
        maybeThrowSpanner( i, spannerfile_count, spannerfile );
    }
