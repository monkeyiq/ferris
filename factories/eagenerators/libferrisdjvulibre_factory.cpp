...
*******************************************************************************
    ...
    $Id: libferrisdjvulibre_factory.cpp,v 1.3 2010/09/24 21:31:27 ben Exp $
...
namespace Ferris
{
    ...
    namespace 
    {
        const char* ext       = "djvu";
        bool        writable  = true;
        string      libname   = AUTOTOOLS_CONFIG_LIBDIR + "/ferris/plugins/eagenerators/libferrisdjvulibre.so";
        const char* shortname = "djvu";
