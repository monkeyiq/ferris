...
*******************************************************************************
    ...
    $Id: libferrisjpeg_factory.cpp,v 1.3 2010/09/24 21:31:28 ben Exp $
...
namespace Ferris
{
    ...
    namespace 
    {
        const char* ext       = "jpeg";
        bool        writable  = false;
        string      libname   = AUTOTOOLS_CONFIG_LIBDIR + "/ferris/plugins/eagenerators/libferrisjpeg.so";
        const char* shortname = "jpeg";
        ...
        bool r2 = Context::RegisterImageEAGeneratorModule(
            "jpg", writable, libname, shortname );
    };
};
