...
*******************************************************************************
    ...
    $Id: libferrismpeg2_factory.cpp,v 1.3 2010/09/24 21:31:28 ben Exp $
...
static Factory::EndingList EL()
{
    ...
    if( virgin )
    {
        ...
        r.push_back( make_pair( string("name"), string(".vob") ));
    }
    ...
    namespace 
    {
        static bool r = RegisterEAGeneratorModule(
             ...
             AUTOTOOLS_CONFIG_LIBDIR + "/ferris/plugins/eagenerators/libferrismpeg2.so",
            "mpeg2",
            false,
            false,
