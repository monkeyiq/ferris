...
*******************************************************************************
    ...
    $Id: libimlib2_factory.cpp,v 1.3 2010/09/24 21:31:30 ben Exp $
...
namespace Ferris
{
    ...
    namespace 
    {
        const char* ext       = "imlib2";
        bool        writable  = false;
        string      libname   = AUTOTOOLS_CONFIG_LIBDIR + "/ferris/plugins/eagenerators/libimlib2.so";
        const char* shortname = "imlib2";
