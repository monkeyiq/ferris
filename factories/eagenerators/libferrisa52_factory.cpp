...
*******************************************************************************
    ...
    $Id: libferrisa52_factory.cpp,v 1.3 2010/09/24 21:31:27 ben Exp $
...
static Factory::EndingList EL()
{
    ...
    if( virgin )
    {
        ...
        r.push_back( make_pair( string("name"), string(".a52") ));
    ...
    namespace 
    {
        static bool r = RegisterEAGeneratorModule(
            ...
            AUTOTOOLS_CONFIG_LIBDIR + "/ferris/plugins/eagenerators/libferrisa52.so",
            "DolbyA52",
            false,
            false,
