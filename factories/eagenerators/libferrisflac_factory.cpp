...
*******************************************************************************
    ...
    $Id: libferrisflac_factory.cpp,v 1.2 2010/09/24 21:31:28 ben Exp $
...
static Factory::EndingList EL()
{
    ...
    namespace 
    {
        static bool r = RegisterEAGeneratorModule(
             ...
             AUTOTOOLS_CONFIG_LIBDIR + "/ferris/plugins/eagenerators/libferrisflac.so",
            "flac",
            false,
             true,
