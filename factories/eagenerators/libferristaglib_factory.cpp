...
*******************************************************************************
    ...
    $Id: libferristaglib_factory.cpp,v 1.2 2010/09/24 21:31:29 ben Exp $
...
static Factory::EndingList EL()
{
...
#ifdef TAGLIB_FOR_MP3
        r.push_back( make_pair( string("name"), string(".mp3") ));
#endif
#ifdef TAGLIB_FOR_OGG
        r.push_back( make_pair( string("name"), string(".ogg") ));
#endif
#ifdef TAGLIB_FOR_FLAC
        r.push_back( make_pair( string("name"), string(".flac") ));
#endif
    ...
    namespace 
    {
        static bool r = RegisterEAGeneratorModule(
             ...
             AUTOTOOLS_CONFIG_LIBDIR + "/ferris/plugins/eagenerators/libferristaglib.so",
             "taglib",
             false,
             true,
