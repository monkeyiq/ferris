...
*******************************************************************************
    ...
    $Id: libferrispng_factory.cpp,v 1.3 2010/09/24 21:31:29 ben Exp $
...
namespace Ferris
{
    ...
    namespace 
    {
        const char* ext       = "png";
        bool        writable  = false;
        string      libname   = AUTOTOOLS_CONFIG_LIBDIR + "/ferris/plugins/eagenerators/libferrispng.so";
        const char* shortname = "png";
