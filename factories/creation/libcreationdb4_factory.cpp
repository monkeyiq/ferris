...
*******************************************************************************
    ...
    $Id: libcreationdb4_factory.cpp,v 1.2 2010/09/24 21:31:25 ben Exp $
...
namespace Ferris
{
    ...
    RegisterCreationModule(
        "libcreationdb4.so",
        "db4",
        "	<elementType name=\"db4\">\n"
        "		<elementType name=\"name\" default=\"new.db\">\n"
        "			<dataTypeRef name=\"string\"/>\n"
        "		</elementType>\n"
        "		<elementType name=\"database-name\" default=\"\">\n"
        "			<dataTypeRef name=\"string\"/>\n"
        "		</elementType>\n"
        "       <elementType name=\"database-type\"> \n"
        "           <dataTypeRef name=\"DB4TypeListT\"/> \n"
        "		</elementType> \n"
        ...
        "	</elementType>\n",
        true,
        "<simpleType name=\"DB4TypeT\">"  
        "    <restriction base=\"string\">"  
        "        <enumeration value=\"Btree\"/>"  
        "        <enumeration value=\"Hash\"/>"  
        "        <enumeration value=\"Queue\"/>"  
        "        <enumeration value=\"Recno\"/>"  
        "    </restriction>"  
        "</simpleType>"  
        "<simpleType name=\"DB4TypeListT\">"  
        "    <list itemType=\"DB4TypeT\"/>"  
        "    <restriction>"  
        "        <length value=\"1\"/>"  
        "    </restriction>"  
        "</simpleType>"  
