...
*******************************************************************************
    ...
    $Id: ferris-export-formal-context-to-burmeister.cpp,v 1.3 2010/09/24 21:31:10 ben Exp $
...
const string PROGRAM_NAME = "ferris-export-concept-lattice-to-burmeister";
        ...
        struct poptOption optionsTable[] =
            {
                ...
                { "output-filename", 'o', POPT_ARG_STRING, &outputFileBase_CSTR, 0,
...
//        poptPrintHelp(optCon, stderr, 0);
        ...
        cl->exportAsBurmeister( outputFileBase );
