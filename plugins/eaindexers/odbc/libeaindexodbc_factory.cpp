...
*******************************************************************************
    ...
    $Id: libeaindexodbc_factory.cpp,v 1.2 2008/07/02 21:30:13 ben Exp $
...
extern "C"
{
    FERRISEXP_API void SetupPlugin()
    {
        RegisterEAIndexPlugin(
            ...
            "		</elementType>\n"
            "		<elementType name=\"use-odbc3-bulkload\" default=\""
            + EAINDEX_ODBC3_BULKLOAD + "\" >\n"
            ...
            "           <default>" CFG_ODBCIDX_EXTRA_COLUMNS_TO_INLINE_IN_DOCMAP_DEFAULT "</default>\n"
            "		</elementType>\n"
