...
*******************************************************************************
    ...
    $Id: libftxidxodbc_factory.cpp,v 1.2 2008/07/02 21:30:15 ben Exp $
...
extern "C"
{
    FERRISEXP_API void SetupPlugin()
    {
        Ferris::RegisterFulltextIndexPlugin(
            "libftxidxodbc.so",
            "fulltextindexodbc",
            "	<elementType name=\"fulltextindexodbc\">\n"
            ...
            "			<dataTypeRef name=\"bool\"/>\n"
            "		</elementType>\n"
            "		<elementType name=\"dsn\" default=\"\" >\n"
            "			<dataTypeRef name=\"string\"/>\n"
            "		</elementType>\n"
            "		<elementType name=\"optimize-for-dbtype\" default=\"\" >\n"
            "			<dataTypeRef name=\"OptimizeForDBTypeT\"/>\n"
            "		</elementType>\n"
            "		<elementType name=\"use-odbc3-bulkload\" default=\"1\" >\n"
            "			<dataTypeRef name=\"bool\"/>\n"
            "		</elementType>\n"
//         "		<elementType name=\"server\" default=\"localhost\" >\n"
//         "			<dataTypeRef name=\"string\"/>\n"
//         "		</elementType>\n"
//         "		<elementType name=\"driver\" default=\"MySQL\" >\n"
//         "			<dataTypeRef name=\"string\"/>\n"
//         "		</elementType>\n"
            "		<elementType name=\"user\" default=\"\" >\n"
            "			<dataTypeRef name=\"string\"/>\n"
            "		</elementType>\n"
//         "		<elementType name=\"password\" default=\"\" >\n"
//         "			<dataTypeRef name=\"string\"/>\n"
//         "		</elementType>\n"
//         "		<elementType name=\"database\" default=\"ferrisfulltextindex\" >\n"
//         "			<dataTypeRef name=\"string\"/>\n"
//         "		</elementType>\n"
            ...
            false
            ,
            "<simpleType name=\"OptimizeForDBTypeT\">"  
