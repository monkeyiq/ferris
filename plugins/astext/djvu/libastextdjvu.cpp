...
*******************************************************************************
    ...
    $Id: libastextdjvu.cpp,v 1.3 2010/09/24 21:31:31 ben Exp $
...
namespace Ferris
{
    ...
    class FERRISEXP_ASTEXT_PLUGIN AsTextStatelessFunctorDJVU
        :
    ...
    extern "C"
    {
        ...
        Create()
        {
            return new AsTextStatelessFunctorDJVU();
        }
    };
};
