...
namespace Ferris
{
    FERRISEXP_EXPORT userpass_t getPastebinUserPass( const std::string& server );
    FERRISEXP_EXPORT void       setPastebinUserPass( const std::string& server,
    ...
    public:
        ...
        std::string request( const std::string& earl, stringmap_t args, const QByteArray& postba );
        void login();
        std::list< std::string > getPageList();
