...
*******************************************************************************
    ...
    $Id: FullTextIndexerCustomFerris.cpp,v 1.2 2010/09/24 21:30:51 ben Exp $
...
#include "config.h"
#include "FullTextIndexerMetaInterface.hh"
...
namespace Ferris
{
    namespace FullTextIndex 
    {
        ...
        namespace 
        {
            MetaFullTextIndexerInterface* CreateFullTextIndexer()
            {
                return CreateFullTextIndexerFromLibrary( "libftxcustomferris.so" );
            }
